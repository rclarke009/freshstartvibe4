...
export type MoneyBlackFridayFragment = Pick<
  StorefrontAPI.MoneyV2,
  'amount' | 'currencyCode'
>;

export type BlackFridayProductFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'handle' | 'title'
> & {
  featuredImage?: StorefrontAPI.Maybe<
...
export type BlackFridayProductQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type BlackFridayProductQuery = {
...
export type PolicyItemProductFragment = Pick<
  StorefrontAPI.ShopPolicy,
  'id' | 'title' | 'handle' | 'url'
>;

export type ProductPoliciesQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ProductPoliciesQuery = {
  shop: {
    shippingPolicy?: StorefrontAPI.Maybe<
      Pick<StorefrontAPI.ShopPolicy, 'id' | 'title' | 'handle' | 'url'>
    >;
    refundPolicy?: StorefrontAPI.Maybe<
      Pick<StorefrontAPI.ShopPolicy, 'id' | 'title' | 'handle' | 'url'>
    >;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query BlackFridayProduct(\n    $country: CountryCode\n    $handle: String!\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    product(handle: $handle) {\n      ...BlackFridayProduct\n    }\n  }\n  #graphql\n  fragment MoneyBlackFriday on MoneyV2 {\n    amount\n    currencyCode\n  }\n  fragment BlackFridayProduct on Product {\n    id\n    handle\n    title\n    featuredImage {\n      id\n      altText\n      url\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        ...MoneyBlackFriday\n      }\n      maxVariantPrice {\n        ...MoneyBlackFriday\n      }\n    }\n    selectedOrFirstAvailableVariant {\n      id\n      price {\n        ...MoneyBlackFriday\n      }\n      compareAtPrice {\n        ...MoneyBlackFriday\n      }\n    }\n  }\n\n': {
    return: BlackFridayProductQuery;
    variables: BlackFridayProductQueryVariables;
  };
  '#graphql\n  query Page(\n    $language: LanguageCode,\n    $country: CountryCode,\n    $handle: String!\n  )\n  @inContext(language: $language, country: $country) {\n    page(handle: $handle) {\n      handle\n      id\n      title\n      body\n      seo {\n        description\n        title\n      }\n    }\n  }\n': {
    return: PageQuery;
  ...
  '#graphql\n  fragment PolicyItemProduct on ShopPolicy {\n    id\n    title\n    handle\n    url\n  }\n  query ProductPolicies($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    shop {\n      shippingPolicy {\n        ...PolicyItemProduct\n      }\n      refundPolicy {\n        ...PolicyItemProduct\n      }\n    }\n  }\n': {
    return: ProductPoliciesQuery;
    variables: ProductPoliciesQueryVariables;
  };

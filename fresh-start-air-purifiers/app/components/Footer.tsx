              ...
              <div className="flex flex-col items-center justify-between gap-2 sm:flex-row">
                ...
                <div className="flex items-center gap-1">
                  <a
                    ...
                    className="group inline-flex h-4 w-4 items-center justify-center rounded-full border border-slate-300 bg-white/90 hover:bg-white"
                    target="_blank" 
                    rel="noopener noreferrer"
                    title="Instagram"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                      className="h-2 w-2 text-gray-600 group-hover:text-[#1e40af]" fill="currentColor">
